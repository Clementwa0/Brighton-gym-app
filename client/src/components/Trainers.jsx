      ...
      <div className="container py-16 mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div data-aos="fade-up">
            <Trainer img={trainerImg1} alt="trainer-1" id="1" name="Prince" age="26" data-aos-delay="100" />
          </div>
          <div data-aos="fade-in" data-aos-delay="300">
            <Trainer img={trainerImg2} alt="trainer-2" id="2" name="Elisabeth" age="40" />
          </div>
          <div data-aos="fade-down" data-aos-delay="500">
            <Trainer img={trainerImg3} alt="trainer-3" id="3" name="Vincent" age="33" />
          </div>
          <div data-aos="zoom-in" data-aos-delay="700">
            <Trainer img={trainerImg4} alt="trainer-4" id="4" name="Brighton Mark" age="24" />
          </div>
        </div>
      </div>
