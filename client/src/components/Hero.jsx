        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10">
          ...
          >
            <h1 className="text-white text-5xl lg:text-7xl xl:text-7xl font-bold leading-tight uppercase heading">
              Visit <span className="text-blue-400 animate-heading">Brighton Gym Kenya</span> <br />
              and love it<br />
              anytime from Monday- Friday anytime from 8am to 5pm. 
            </h1>
            <p className="text-gray-300 text-lg md:text-xl mt-4 lg:mt-6 max-w-md mx-auto md:mx-0">
              Fuel your ambition with expert coaching, dynamic workouts, and real accountability.
            </p>
