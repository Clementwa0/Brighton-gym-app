...
const Plan = ({name, img, alt, id, monthlyPrice, yearlyPrice}) => {
  return (
    ...
    <div className="space-y-2">
      <p className="text-lg">Monthly: <span className="font-bold">Ksh{monthlyPrice}</span></p>
      <p className="text-lg">Yearly: <span className="font-bold">Ksh{yearlyPrice}</span></p>
    </div>
    <Link 
      to={`/plan-detail/${id}`}
